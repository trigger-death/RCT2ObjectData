...
namespace RCT2ObjectData.Objects.Types.AttractionInfo {
	...
	public enum CarFlags : ulong {
		...
		SpinningIndependantWheels = 1 << 14,
	...
	public enum CarEffectVisuals : byte {
	...
	public enum CarSpriteFlags : ushort {
		 ...
		 *</summary>*/
		FlatToGentleSlopeBankedTransitions = 1 << 7,
		 ...
		 *</summary>*/
		DiagonalGentleSlopeBankedTransitions = 1 << 8,
		/**<summary>All gentle slope bank transition car sprites. Consists of:
		 * <para>Four 4-frame rotations angled up-left, up-right, down-left, then down-right at a gentle slope to gentle slope bank transition.</para>
		 *</summary>*/
		GentleSlopeBankedTransitions = 1 << 9,
		 ...
		 *</summary>*/
		FlatToGentleSlopeWhileBankedTransitions = 1 << 11,
