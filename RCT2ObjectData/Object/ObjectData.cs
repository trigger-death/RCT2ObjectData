...
namespace RCT2ObjectData.Objects {
	...
	/**<summary>An entry for locating an object.</summary>*/
	public class ObjectEntry {
		//=========== MEMBERS ============
		#region Members

		/**<summary>The flags of the object file.</summary>*/
		public uint Flags;
		/**<summary>The name of the object file.</summary>*/
		public string FileName;
		/**<summary>The checksum of the object file.</summary>*/
		public uint CheckSum;
		...
		/**<summary>Constructs the default object entry.</summary>*/
		public ObjectEntry()
		{
			Flags = 0x0;
			FileName = "";
		...
		/**<summary>Constructs the default object entry.</summary>*/
		public ObjectEntry(uint flags, string fileName, uint checksum)
		{
			Flags = flags;
			FileName = fileName;
			CheckSum = checksum;
		...
		/**<summary>Reads the object entry.</summary>*/
		public void Read(BinaryReader reader)
		{
		...
		/**<summary>Writes the object entry.</summary>*/
		public void Write(BinaryWriter writer)
		{
			writer.Write(Flags);
			for (int i = 0; i < 8; i++)
